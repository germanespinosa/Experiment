...
void EmptyLinkFunctionForGeneratedCodeTCPMessages_init() {}
	...
	UPackage* Z_Construct_UPackage__Script_TCPMessages()
	{
		...
		if (!ReturnPackage)
		{
			static UObject* (*const SingletonFuncArray[])() = {
				(UObject* (*)())Z_Construct_UDelegateFunction_TCPMessages_OnMessageReceived__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_TCPMessages_OnResponseReceived__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_TCPMessages_OnResponseTimeOut__DelegateSignature,
			};
